---
title: 问题排查指南 | PiDeck pi desktop 故障诊断
description: PiDeck 问题排查手册：会话起不来、pi 连接失败、白屏闪退、Git 面板异常、终端无法输入等故障的诊断步骤与修复方案，附环境诊断报告导出方法。
---
...
3. 加入 **QQ 群：1026218644** 或加 **作者微信：caoayu97** 交流。
