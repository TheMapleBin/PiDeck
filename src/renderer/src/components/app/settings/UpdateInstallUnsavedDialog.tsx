		...
		>
			<AlertDialogContent>
				...
				<AlertDialogFooter>
					...
					<AlertDialogAction className={buttonVariants({ variant: "destructive" })} onClick={props.onDiscardAndInstall}>
						{t("settings.discardAndInstall")}
					</AlertDialogAction>
					<AlertDialogAction onClick={() => void props.onSaveAndInstall()}>{t("settings.saveAndInstall")}</AlertDialogAction>
				</AlertDialogFooter>
			</AlertDialogContent>
		</AlertDialog>
	);
