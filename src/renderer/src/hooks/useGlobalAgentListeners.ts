...
type GlobalAgentListenerCallbacks = {
	...
	onTrustRequest?: (request: { requestId: string; cwd: string; projectName: string }) => void;
};

export function useGlobalAgentListeners(callbacks: GlobalAgentListenerCallbacks = {}): void {
