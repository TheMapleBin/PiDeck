...
function makePseudoDictionary(source: Record<TranslationKey, string>): Record<TranslationKey, string> {
...
export function translateI18nDescriptor(descriptor: I18nDescriptor | null | undefined, fallback: string): string {
