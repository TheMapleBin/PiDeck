...
export const enUS: Record<TranslationKey, string> = {
	...
	"app.quickMessagesEmpty": "No quick messages yet — add some in Settings → Common → Quick messages",
	...
	"settings.quickMessagesSectionDesc": "The list opened by the quick-message button in the composer bar: click an item to insert it into the draft, or use the button on its right to send it right away (your half-written draft is left untouched).",
	...
	"providerLogin.noProviders": "This pi version exposes no providers to sign in to.",
	"providerLogin.listFailed": "Could not read the provider list",
	"providerLogin.method.oauth": "Browser sign-in",
	"providerLogin.method.oauthHint": "Open the provider page and finish authorization (the link or code appears in the window or terminal).",
