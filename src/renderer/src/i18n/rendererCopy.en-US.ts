...
export const enUS: Record<TranslationKey, string> = {
  ...
  "config.dsh.title": "DSH Configuration",
	...
	"config.dsh.hostStartFailed": "Failed to start the DSH host; retry or restart the app.",
  ...
  "config.process.section": "Running processes",
	...
	"config.process.dshHostStopped": "Stopped",
	"config.process.dshHostIdleHint": "Stays stopped after a manual stop until you start it or open a DSH session.",
  ...
  "config.process.stopHostConfirm": "Stop the DSH host? This ends all DSH sessions and closes the shared host process. Session files are kept and can be reopened.",
	...
	"config.process.started": "{agent} started",
	"config.process.stopFailed": "Failed to stop {agent}",
	"config.process.startFailed": "Failed to start {agent}",
