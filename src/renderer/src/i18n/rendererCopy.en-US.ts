...
export const enUS: Record<TranslationKey, string> = {
	...
	"providerLogin.running.browserHint": "The authorization page is open in your system browser — this dialog continues automatically once you finish.",
	"providerLogin.running.slowTitle": "No result after {{seconds}}s",
	"providerLogin.running.slowHint": "If the browser already confirmed the sign-in, this machine most likely cannot reach the provider directly (region restriction). Configure a proxy in Settings, then cancel and retry.",
