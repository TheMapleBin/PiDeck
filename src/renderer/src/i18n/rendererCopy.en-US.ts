...
"config.proxyUrlUnset": "No proxy URL configured",
  ...
  "settings.dshRunnerNodeDesc": "On Windows, DSH sandbox commands need a local Node 24 node.exe (console subsystem) so electron.exe does not flash a black window. Leave empty to auto-detect PATH and common install locations. Not bundled in the installer.",
  ...
  "settings.dshRunnerNodeUseDetected": "Use detected Node",
  "settings.dshRunnerNodeMissingHint": "Node 24 was not found. Install it from https://nodejs.org/ and set node.exe in Developer settings, or DSH sandbox commands may flash a black console.",
