...
export const zhCN = {
	...
	"app.quickMessagesEmpty": "还没有快捷消息，可在「设置 → 常用设置 → 快捷消息」里维护",
	...
	"settings.quickMessagesSectionDesc": "输入框底栏「快捷消息」按钮打开的清单：点条目插入草稿，条目右侧按钮直接发送（不会动已经写了一半的输入）。",
	...
	"providerLogin.noProviders": "当前 pi 版本没有提供可登录的供应商。",
	"providerLogin.listFailed": "读取供应商列表失败",
	"providerLogin.method.oauth": "浏览器授权",
	"providerLogin.method.oauthHint": "打开供应商页面完成授权（新窗口或终端里会显示链接/验证码）。",
