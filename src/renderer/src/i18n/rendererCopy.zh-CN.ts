...
export const zhCN = {
  ...
  "config.dsh.title": "DSH 配置管理",
	...
	"config.dsh.hostStartFailed": "DSH host 启动失败，请重试或重启应用。",
  ...
  "config.process.section": "运行中进程",
	...
	"config.process.dshHostStopped": "已停止",
	"config.process.dshHostIdleHint": "手动停止后保持停止，直到你点启动或打开一个 DSH 会话。",
  ...
  "config.process.stopHostConfirm": "停止 DSH Host？将结束全部 DSH 会话并关闭共享 host 进程（会话文件仍保留，可再打开）。",
	...
	"config.process.started": "{agent} 已启动",
	"config.process.stopFailed": "停止 {agent} 失败",
	"config.process.startFailed": "启动 {agent} 失败",
