 ...
 */
export function updateActiveToolCalls(current: ReadonlyMap<string, string>, event: { type: "start"; toolCallId: string; toolName: string } | { type: "end"; toolCallId: string }): ActiveToolCallState {
