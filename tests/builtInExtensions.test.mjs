...
test("listActiveBuiltInExtensionPaths respects removedBuiltIn and missing files", () => {
	...
	try {
		...
		// 内置扩展清单随版本增长：ask/file-links/goal/nul-redirect/plan-mode/request-size-recovery/retry-no-body/security-gate/session-title/subagents/todo/trash-guard/vision
