...
const { filePathFromHref, normalizeLocalFilePath, stripFileLocation, toInternalFileHref } = loadTsCommonJs("src/renderer/src/utils/fileLinks.ts");

test("本地文件目标可规范化并往返 href", () => {
	const localTargets = ["C:/Users/Administrator/.pi/agent/settings.json", "C:\\Users\\Administrator\\.pi\\agent\\settings.json", "/C:/Users/Administrator/project/src/App.tsx:392", "/home/user/project/src/app.py:12:4", "./src/app.ts", "../docs/README.md", "src/components/App.tsx:42", "settings.json", "settings.json:8"];
...
test("外部目标一律拒绝", () => {
	const externalTargets = ["https://example.com/docs/readme.md", "http://example.com/file.json", "mailto:user@example.com", "#section", "/docs/getting-started", "//example.com/docs/file.md"];
...
test("行号剥离与 href 解码", () => {
	...
	assert.equal(filePathFromHref("file://C%3A%2FUsers%2FTest%2FMy%20File.ts%3A9"), "C:/Users/Test/My File.ts:9");
});

test("Markdown 链接目标同样识别为本地文件", () => {
	const markdownTargets = ["[settings.json](C:/Users/Administrator/.pi/agent/settings.json)", "[App.tsx](/C:/Users/Administrator/project/src/App.tsx:392)", "[app.py](/home/user/project/app.py:12:4)", "[README](../docs/README.md)"];
