...
const { countSelectedModelIndexes, getModelSelectionState, removeSelectedModelIndexes, toggleAllModelIndexes, toggleModelIndex } = loadTsCommonJs("src/renderer/src/config/modelBatchSelection.ts");
