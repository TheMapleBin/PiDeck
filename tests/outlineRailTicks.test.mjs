...
const railTicks = compile("src/renderer/src/components/session/timeline/outlineRailTicks.ts");

const makeItems = (count) => Array.from({ length: count }, (_, index) => ({ id: `msg-${index}` }));
