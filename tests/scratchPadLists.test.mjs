...
const { continueListOnNewline, normalizeOrderedLists, prepareTaskListPreview, toggleTaskCheckbox } = loadTsCommonJs("src/renderer/src/components/scratchPad/scratchPadLists.ts");
...
test("scratch pad renumbers ordered Markdown after a middle item is deleted", () => {
	assert.equal(normalizeOrderedLists("1. first\n3. third\n4. fourth"), "1. first\n2. third\n3. fourth");
	assert.equal(normalizeOrderedLists("1. first\n\n3. separate list"), "1. first\n\n3. separate list");
});
