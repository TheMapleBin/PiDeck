...
const progress = readFileSync("src/renderer/src/components/ui-shadcn/progress.tsx", "utf8");
...
test("settings update card uses the shared Progress with an accessible label", () => {
	assert.match(updateCard, /<Progress value=\{download\.percent \?\? 0\} aria-label=\{t\("settings\.updateDownloading", \{ version: "" \}\)\} \/>/);
