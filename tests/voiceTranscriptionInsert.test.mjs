...
vm.runInNewContext(ts.transpileModule(readFileSync("src/renderer/src/utils/voiceTranscriptionInsert.ts", "utf8"), { compilerOptions: { module: ts.ModuleKind.CommonJS, target: ts.ScriptTarget.ES2022 } }).outputText, { module, exports: module.exports });
